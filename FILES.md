...
SYS:014E 26            ES:
SYS:014F 3B060800      CMP	AX,[0008]
SYS:0153 7206          JB	015B
SYS:0155 26            ES:
SYS:0156 A11400        MOV	AX,[0014]
SYS:0159 EBD1          JMP	012C
SYS:015B 8BC8          MOV	CX,AX
SYS:015D 8CC3          MOV	BX,ES
SYS:015F 2B1E3800      SUB	BX,[0038]
SYS:0163 83EB10        SUB	BX,+10
SYS:0166 890E3400      MOV	[0034],CX
SYS:016A 891E3600      MOV	[0036],BX
SYS:016E C41E2E00      LES	BX,[002E]
SYS:0172 8CC0          MOV	AX,ES
SYS:0174 0BC3          OR	AX,BX
SYS:0176 7413          JZ	018B
SYS:0178 33C0          XOR	AX,AX
SYS:017A A32E00        MOV	[002E],AX
SYS:017D A33000        MOV	[0030],AX
SYS:0180 A33C00        MOV	[003C],AX
...
SYS:0189 53            PUSH	BX
SYS:018A CB            RETF
SYS:018B B85000        MOV	AX,0050
SYS:018E 1E            PUSH	DS
SYS:018F 50            PUSH	AX
SYS:0190 0E            PUSH	CS
SYS:0191 E82A02        CALL	03BE
SYS:0194 B85001        MOV	AX,0150
SYS:0197 1E            PUSH	DS
SYS:0198 50            PUSH	AX
SYS:0199 0E            PUSH	CS
...
SYS:028C 87063C00      XCHG	AX,[003C]
SYS:0290 CB            RETF
SYS:0291 833E3C0000    CMP	WORD PTR [003C],+00
SYS:0296 7501          JNZ	0299
SYS:0298 CB            RETF
SYS:0299 A13C00        MOV	AX,[003C]
...
SYS:038A C7063C006600  MOV	WORD PTR [003C],0066
...
SYS:03D6 C7063C006700  MOV	WORD PTR [003C],0067
