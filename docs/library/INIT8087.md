...
Test for presence and identify **[FPU](../DATA.md)** with a call to **[SYS:074C Identify 8087/80287/80387 FPU](TEST8087.md)**.
...
Initialize **FPU** handlers routines with a jump to **SYS:07D9**.
