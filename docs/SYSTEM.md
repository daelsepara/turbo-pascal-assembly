...
SYS:0038 26            ES:
SYS:0039 A10200        MOV	AX,[OvrCodeList]
...
SYS:02FA AB            STOSW
SYS:02FB B88000        MOV	AX,TextBuf
SYS:02FE AB            STOSW
...
SYS:0343 26            ES:
SYS:0344 894504        MOV	[DI:BufSize],AX
SYS:0347 36            SS:
SYS:0348 8B4706        MOV	AX,[BX+06]
SYS:034B 26            ES:
SYS:034C 89450C        MOV	[DI:BufPtr.Offset],AX
SYS:034F 36            SS:
SYS:0350 8B4708        MOV	AX,[BX+08]
SYS:0353 26            ES:
SYS:0354 89450E        MOV	[DI:BufPtr.Segment],AX
SYS:0357 33C0          XOR	AX,AX
SYS:0359 26            ES:
SYS:035A 894508        MOV	[DI:BufPos],AX
SYS:035D 26            ES:
SYS:035E 89450A        MOV	[DI:BufEnd],AX
